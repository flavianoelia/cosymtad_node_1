          ...
          <div class="container-fluid">
            <nav class="navbar navbar-expand-lg custom_nav-container ">
              <a class="navbar-brand" href="index.html">
                <img src="./images/Logo FCA color.png" alt="logo">
              </a>
...
<div class="container mt-5">
  <h1 class="mb-4">Gracias por tus respuestas</h1>
  <h2 class="mb-4">Tu aporte es muy valioso para la mejora continua de la calidad de nuestros docentes</h2>
  <br>
</div>
  ...
  <section class="info_section ">
    <div class="container">
      <div class="info_top">
        <div class="info_logo">
          <a href="">
            <img src="./images/Logo FCA color.png" alt="">
          </a>
        </div>
        <div class="info_form">
